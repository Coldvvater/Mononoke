    ...
    await Promise.all([check_youtube_premium(), check_netflix()])
      .then((result) => {
        ...
        if (status == STATUS_COMING) {
          ...
          //console.log(2)
          console.log(region)
          disney_result = "Disney+: 已经解锁 ➟ " + region.toUpperCase()
  ...
  await inner_check()
    .then((code) => {
      if (code === 'Not Available') {
        ...
        youtube_check_result += '已经解锁 ➟ ' + code.toUpperCase()
      }
    })
    .catch((error) => {
...
async function check_netflix() {
  ...
  await inner_check(81215567)
    .then((code) => {
      ...
      netflix_check_result += '完整解锁 ➟ ' + code.toUpperCase()
