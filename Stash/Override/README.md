...
4. 回到 Stash 首页，把「**覆写**」、「**重写**」、「**脚本**」几个开关打开。这里基本准备就绪，然后前往仓库里获取覆写 **raw** 链接，手机端浏览器打开GitHub仓库，选择你需要的覆写，点击右边的三个点点•••，点击后会看到菜单，点击 **View** ，跳转后复制地址栏的覆写链接，回到 Stash 首页，点击「**覆写**」，进入覆写列表，这里是你要安装和显示已安装的覆写的地方，点击右上角 + 号，在输入框粘贴你刚才复制的覆写链接，点击**下载**，点击**安装**，安装成功！
